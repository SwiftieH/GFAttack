...
class Nettack:
    ...
    def __init__(self, adj, X_obs, z_obs, u, X_mean, eig_vals, eig_vec, perturb_logs):
    ...
    def attack_model(self, n_perturbations, delta_cutoff=0.004):
        ...
        for _ in range(n_perturbations):
            ...
            eigen_scores = utils.cal_scores(self.adj, self.X_obs, self.X_mean, self.eig_vals, self.eig_vec, filtered_edges_final, K=2, T=128, lambda_method = "nosum")

            struct_scores = eigen_scores.reshape(eigen_scores.shape[0],1)
